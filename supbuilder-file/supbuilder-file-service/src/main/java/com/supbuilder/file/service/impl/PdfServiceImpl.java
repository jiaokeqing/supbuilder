...
public class PdfServiceImpl implements PdfService {
    ...
    @Override
    public void toPpt(MultipartFile pdfFile, String fileId) {
        String timeDir = System.currentTimeMillis() + File.separator;
        try {
            //创建转换目录
            Path converseDir = Paths.get(conversedResultPath + timeDir);
            ...
            sourceFile = UploadFileUtil.uploadFile(pdfFile, converseUploadPath + timeDir);
            String name = FileNameUtil.mainName(sourceFile);
            String targetFile = conversedResultPath + timeDir + name + FileTypeSuffixConstants.PPTX_SUFFIX;
            String downloadUrl = converseDownLoadUrl + timeDir + name + FileTypeSuffixConstants.PPTX_SUFFIX;

            converseService.pdf2Ppt(sourceFile, targetFile, downloadUrl, fileId);
    ...
    @Override
    public void toExcel(MultipartFile pdfFile, String fileId) {
        String timeDir = System.currentTimeMillis() + File.separator;
        try {
            //创建转换目录
            Path converseDir = Paths.get(conversedResultPath + timeDir);
            ...
            sourceFile = UploadFileUtil.uploadFile(pdfFile, converseUploadPath + timeDir);
            String name = FileNameUtil.mainName(sourceFile);
            String targetFile = conversedResultPath + timeDir + name + FileTypeSuffixConstants.XLSX_SUFFIX;
            String downloadUrl = converseDownLoadUrl + timeDir + name + FileTypeSuffixConstants.XLSX_SUFFIX;

            converseService.pdf2Excel(sourceFile, targetFile, downloadUrl, fileId);
    ...
    @Override
    public void toTxt(MultipartFile pdfFile, String fileId) {
        String timeDir = System.currentTimeMillis() + File.separator;
        try {
            //创建转换目录
            Path converseDir = Paths.get(conversedResultPath + timeDir);
            ...
            sourceFile = UploadFileUtil.uploadFile(pdfFile, converseUploadPath + timeDir);
            String name = FileNameUtil.mainName(sourceFile);
            String targetFile = conversedResultPath + timeDir + name + FileTypeSuffixConstants.TXT_SUFFIX;
            String downloadUrl = converseDownLoadUrl + timeDir + name + FileTypeSuffixConstants.ZIP_SUFFIX;

            converseService.pdf2Txt(sourceFile, targetFile, downloadUrl, fileId);
    ...
    @Override
    public void toHtml(MultipartFile pdfFile, String fileId) {
        String timeDir = System.currentTimeMillis() + File.separator;
        try {
            //创建转换目录
            Path converseDir = Paths.get(conversedResultPath + timeDir);
            ...
            sourceFile = UploadFileUtil.uploadFile(pdfFile, converseUploadPath + timeDir);
            String name = FileNameUtil.mainName(sourceFile);
            String targetFile = conversedResultPath + timeDir + name + FileTypeSuffixConstants.HTML_SUFFIX;
    ...
    @Override
    public void pdfSplitByRange(MultipartFile pdfFile, String range, String fileId) {
        String timeDir = System.currentTimeMillis() + File.separator;
        try {
            //创建转换目录
            Path converseDir = Paths.get(conversedResultPath + timeDir);
            ...
            converseService.pdfSplitByRange(sourceFile, targetFile, downloadUrl, fileId, range);
