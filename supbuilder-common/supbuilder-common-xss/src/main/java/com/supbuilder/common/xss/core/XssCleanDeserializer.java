...
import com.supbuilder.common.core.util.SpringContextHolder;
...
public class XssCleanDeserializer extends XssCleanDeserializerBase {
	...
	public String clean(String name, String text) throws IOException {
		// 读取 xss 配置
		SupbuilderXssProperties properties = SpringContextHolder.getBean(SupbuilderXssProperties.class);
		// 读取 XssCleaner bean
