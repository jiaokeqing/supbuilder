 ...
 */
public final class SupbuilderSentinelFeign {

	private SupbuilderSentinelFeign() {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new SupbuilderSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new SupbuilderSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new SupbuilderSentinelInvocationHandler(target, dispatch);
				}
