...
package com.supbuilder.common.feign.sentinel.ext;
 ...
 */
@Slf4j
public class SupbuilderSentinelInvocationHandler implements InvocationHandler {
	...
	SupbuilderSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			SupbuilderSentinelInvocationHandler other = (SupbuilderSentinelInvocationHandler) obj;
